			...
			<div id="news-updates">
				...
				<div class="news-article ">
					<div style="text-align:left">
						<p><strong>Vous souhaitez rejoindre la communauté <?php echo $site->nom_site; ?> et tenter une aventure formidable ?</strong><br /> 
				...
				<div class="news-article ">
					<div style="text-align:left">
						...
						<div id="2" style="display: none;">
							<p>L'installateur que vous avez téléchargé vous a offre un jeu complet mais pas spécialement à la dernière version actuelle de <?php echo $site->nom_site; ?> : 3.3.5<br /> 
				...
				<div class="news-article ">
					<div style="text-align:left">
						...
						<div id="4" style="display: none;">
							<p>Votre jeu est maintenant à la bonne version pour rejoindre <?php echo $site->nom_site; ?>.<br /> 
							Il reste une chose importante à faire: Créer son compte et vous pouvez faire cela sur cette page.<br /> 
							L'équipe <?php echo $site->nom_site; ?> vous conseille d'indiquer un email valide, il vous permettra de récupérer votre mot de passe et recevoir des newslettres, (...)</p> 
							...
							L'équipe <a><?php echo $site->nom_site; ?></a>.</strong></em></p>	
						</div>
					</div>
				</div>
			</div>
